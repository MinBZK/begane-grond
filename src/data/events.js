...
export const eventCatalog = [
  // Infra
  { type: 'infra.instance.requested', source: 'infra', label: 'Dienst aangevraagd', severity: 'info', icon: 'cylinder-split' },
  { type: 'infra.instance.ready', source: 'infra', label: 'Dienst gereed', severity: 'success', icon: 'check-mark-circle' },
  { type: 'infra.instance.scaled', source: 'infra', label: 'Dienst geschaald', severity: 'info', icon: 'arrow-up-arrow-down' },
  ...
  { type: 'pipeline.passed', source: 'environments', label: 'Pijplijn groen', severity: 'success', icon: 'check-mark-circle' },
  { type: 'pipeline.failed', source: 'environments', label: 'Pijplijn rood', severity: 'critical', icon: 'exclamation-triangle' },
  ...
  { type: 'incident.mitigated', source: 'incidenten', label: 'Incident gemitigeerd', severity: 'warning', icon: 'shield-check-mark' },
  { type: 'incident.resolved', source: 'incidenten', label: 'Incident opgelost', severity: 'success', icon: 'check-mark-circle' },
  { type: 'change.requested', source: 'incidenten', label: 'Wijziging aangevraagd', severity: 'info', icon: 'calendar-event' },
  { type: 'change.approved', source: 'incidenten', label: 'Wijziging goedgekeurd', severity: 'success', icon: 'check-mark-circle' },
  // Observability
  { type: 'alert.firing', source: 'observability', label: 'Alert actief', severity: 'warning', icon: 'eye' },
  { type: 'alert.resolved', source: 'observability', label: 'Alert opgelost', severity: 'success', icon: 'check-mark-circle' },
  { type: 'slo.budget-low', source: 'observability', label: 'SLO-budget laag', severity: 'warning', icon: 'exclamation-circle' },
  // Security
  { type: 'vuln.detected', source: 'security', label: 'Kwetsbaarheid gevonden', severity: 'critical', icon: 'shield-check-mark' },
  { type: 'vuln.resolved', source: 'security', label: 'Kwetsbaarheid opgelost', severity: 'success', icon: 'check-mark-circle' },
  { type: 'scan.completed', source: 'security', label: 'Scan voltooid', severity: 'info', icon: 'magnifier' },
  { type: 'compliance.dropped', source: 'security', label: 'Compliance gezakt', severity: 'warning', icon: 'exclamation-triangle' },
  // Secrets
  { type: 'secret.rotated', source: 'secrets', label: 'Secret geroteerd', severity: 'info', icon: 'lock-closed' },
  { type: 'secret.expiring', source: 'secrets', label: 'Secret verloopt binnenkort', severity: 'warning', icon: 'clock' },
  { type: 'cert.expiring', source: 'secrets', label: 'Certificaat verloopt binnenkort', severity: 'warning', icon: 'certificate' },
  // Cost / FinOps
  { type: 'cost.budget-exceeded', source: 'kosten', label: 'Budget overschreden', severity: 'warning', icon: 'euro-sign' },
  { type: 'cost.anomaly', source: 'kosten', label: 'Kosten-afwijking', severity: 'warning', icon: 'euro-sign' },
  // Fleet
  { type: 'fleet.campaign.started', source: 'fleet', label: 'Fleet-campagne gestart', severity: 'info', icon: 'ship-wheel' },
  { type: 'fleet.pr.opened', source: 'fleet', label: 'Fleet-PR geopend', severity: 'info', icon: 'folder-stack' },
  { type: 'fleet.pr.merged', source: 'fleet', label: 'Fleet-PR gemerged', severity: 'success', icon: 'check-mark-circle' },
  { type: 'fleet.pr.failing', source: 'fleet', label: 'Fleet-PR faalt op CI', severity: 'warning', icon: 'exclamation-triangle' },
  // Code: pull requests, reviews, issues, commits, CI — the full code-host feed
  { type: 'pr.opened', source: 'code', label: 'Pull request geopend', severity: 'info', icon: 'chevron-left-forward-slash-chevron-right' },
  { type: 'pr.review-requested', source: 'code', label: 'Review gevraagd', severity: 'info', icon: 'eye' },
  { type: 'pr.reviewed', source: 'code', label: 'Review geplaatst', severity: 'info', icon: 'eye' },
  { type: 'pr.changes-requested', source: 'code', label: 'Wijzigingen gevraagd', severity: 'warning', icon: 'pencil' },
  { type: 'pr.approved', source: 'code', label: 'PR goedgekeurd', severity: 'success', icon: 'check-mark-circle' },
  { type: 'pr.merged', source: 'code', label: 'PR gemerged', severity: 'success', icon: 'check-mark-circle' },
  { type: 'pr.closed', source: 'code', label: 'PR gesloten', severity: 'info', icon: 'dismiss-circle' },
  { type: 'ci.passed', source: 'code', label: 'CI groen', severity: 'success', icon: 'check-mark-circle' },
  { type: 'ci.failed', source: 'code', label: 'CI rood', severity: 'critical', icon: 'exclamation-triangle' },
  { type: 'issue.opened', source: 'code', label: 'Issue geopend', severity: 'info', icon: 'exclamation-circle' },
  ...
  // Werkplekken
  { type: 'workplace.provisioned', source: 'werkplekken', label: 'Werkplek uitgerold', severity: 'success', icon: 'rectangle-stack' },
  { type: 'workplace.non-compliant', source: 'werkplekken', label: 'Werkplek niet compliant', severity: 'warning', icon: 'exclamation-triangle' },
  // Teams / on-call
  { type: 'oncall.handover', source: 'teams', label: 'Piket-overdracht', severity: 'info', icon: 'person-2' },
  { type: 'oncall.escalation', source: 'teams', label: 'Escalatie', severity: 'critical', icon: 'exclamation-triangle' },
  // AI / skills
  { type: 'ai.skill.installed', source: 'ai', label: 'AI-skill geïnstalleerd', severity: 'info', icon: 'puzzle-piece' },
  { type: 'ai.key.created', source: 'ai', label: 'LLM-key aangemaakt', severity: 'info', icon: 'sparkles' },
  { type: 'ai.agent.completed', source: 'ai', label: 'AI-agent-run klaar', severity: 'success', icon: 'sparkles' },
  // Governance
  { type: 'governance.gate-failed', source: 'governance', label: 'Beleids-gate gefaald', severity: 'warning', icon: 'certificate' },
  { type: 'rfc.status-changed', source: 'governance', label: 'RFC-status gewijzigd', severity: 'info', icon: 'file-text' },
  // Physical
  { type: 'cooling.alert', source: 'fysiek', label: 'Koeling-alert', severity: 'warning', icon: 'exclamation-triangle' },
...
export const eventSeed = [
  { type: 'incident.opened', severity: 'critical', team: 'team-toeslagen', actor: 'system', title: 'Verhoogde latency Toeslagenmotor', resource: 'inc-2024-017', target: '/incidenten/inc-2024-017', at: 'vandaag 09:14' },
  { type: 'cost.budget-exceeded', severity: 'warning', team: 'team-toeslagen', actor: 'system', title: 'Toeslagen over budget: €300 / €280', resource: 'team-toeslagen', target: '/kosten/budgetten', at: 'vandaag 08:55' },
  { type: 'alert.firing', severity: 'warning', team: 'team-toeslagen', actor: 'system', title: 'p99 latency boven SLO (app-toeslagen)', resource: 'app-toeslagen', target: '/observability/alerts', at: 'vandaag 08:40' },
  { type: 'vuln.detected', severity: 'critical', team: 'team-toeslagen', actor: 'system', title: 'CVE-2024-3094 in repo-toeslagen', resource: 'repo-toeslagen', target: '/security/kwetsbaarheden', at: 'gisteren 22:18' },
  { type: 'incident.resolved', severity: 'success', team: 'team-burgerzaken', actor: 'joost', title: 'pg-burgerzaken-prod hoge temperatuur opgelost', resource: 'inc-2024-016', target: '/incidenten/inc-2024-016', at: 'gisteren 16:30' },
  { type: 'cooling.alert', severity: 'warning', team: 'team-platform', actor: 'system', title: 'Koeling-alert rack DH-A1', resource: 'r-dh-a1', target: '/fysiek/racks/r-dh-a1', at: 'gisteren 16:02' },
  { type: 'deploy.completed', severity: 'success', team: 'team-burgerzaken', actor: 'joost', title: 'app-paspoort v2.3.9 naar prod', resource: 'app-paspoort', target: '/apps/app-paspoort', at: 'gisteren 14:22' },
  { type: 'cert.expiring', severity: 'warning', team: 'team-data', actor: 'system', title: 'api.datadeling.overheid.nl verloopt over 30 dagen', resource: 'cert-2', target: '/secrets/certificaten', at: 'gisteren 11:02' },
  { type: 'deploy.completed', severity: 'success', team: 'team-platform', actor: 'ans', title: 'app-platformportaal v0.6.5 naar prod', resource: 'app-platformportaal', target: '/apps/app-platformportaal', at: 'gisteren 10:05' },
  { type: 'fleet.pr.merged', severity: 'success', team: 'team-platform', actor: 'ans', title: 'NLDD-bump PR gemerged in platformportaal', resource: 'camp-nldd-bump', target: '/fleet/camp-nldd-bump', at: 'gisteren 09:30' },
  { type: 'secret.rotated', severity: 'info', team: 'team-platform', actor: 'fatima', title: 'platform/llm-gateway-key geroteerd', resource: 'sec-3', target: '/secrets', at: 'di 09:40' },
  { type: 'infra.instance.ready', severity: 'success', team: 'team-platform', actor: 'ans', title: 'llm-gilde-prod gereed', resource: 'llm-gilde-prod', target: '/infra/instances/llm-gilde-prod', at: 'di 10:02' },
  { type: 'fleet.pr.failing', severity: 'warning', team: 'team-platform', actor: 'system', title: 'security.txt-PR faalt op CI in repo-toeslagen', resource: 'camp-securitytxt', target: '/fleet/camp-securitytxt', at: 'di 08:15' },
  { type: 'oncall.handover', severity: 'info', team: 'team-platform', actor: 'fatima', title: 'Piket overgedragen aan Fatima El Amrani', resource: 'team-platform', target: '/teams/on-call', at: 'ma 09:00' },
  { type: 'change.approved', severity: 'success', team: 'team-platform', actor: 'fatima', title: 'Postgres major upgrade 15 naar 16 goedgekeurd', resource: 'chg-221', target: '/incidenten/changes', at: 'ma 08:30' },
  { type: 'ai.skill.installed', severity: 'info', team: 'team-platform', actor: 'ans', title: 'NeRDS-skills geïnstalleerd', resource: 'nerds', target: '/ai/skills', at: 'vr 15:20' },
  { type: 'workplace.provisioned', severity: 'success', team: 'team-platform', actor: 'ans', title: 'Werkplek wp-0002 uitgerold aan Fatima', resource: 'wp-0002', target: '/werkplekken/wp-0002', at: 'vr 11:10' },
  { type: 'vuln.resolved', severity: 'success', team: 'team-data', actor: 'pieter', title: 'CVE-2023-44487 opgelost in datadeling-api', resource: 'repo-datadeling', target: '/security/kwetsbaarheden', at: 'do 16:45' },

  // Code / PR / issue feed — the platform is fed by code.overheid.nl too.
  { type: 'pr.opened', severity: 'info', team: 'team-toeslagen', actor: 'sanne', title: 'PR #318 geopend: retry-logica voor Kafka-consumer', resource: 'repo-toeslagen', target: '/code/repo-toeslagen', at: 'vandaag 09:02' },
  { type: 'ai.pr-review.posted', severity: 'info', team: 'team-toeslagen', actor: 'system', title: 'AI-PR-review op #318: 1 kritiek, 1 beveiliging', resource: 'repo-toeslagen', target: '/ai', at: 'vandaag 09:05' },
  { type: 'ci.failed', severity: 'critical', team: 'team-toeslagen', actor: 'system', title: 'CI rood op #318 (repo-toeslagen)', resource: 'repo-toeslagen', target: '/code/repo-toeslagen', at: 'vandaag 09:07' },
  { type: 'pr.review-requested', severity: 'info', team: 'team-platform', actor: 'sanne', title: 'Review gevraagd aan Anne Schuth op #90', resource: 'repo-toeslagen', target: '/code/repo-toeslagen', at: 'gisteren 13:40' },
  { type: 'pr.merged', severity: 'success', team: 'team-platform', actor: 'ans', title: 'PR #12 gemerged: NLDD-bump in platformportaal', resource: 'repo-platformportaal', target: '/code/repo-platformportaal', at: 'gisteren 09:28' },
  { type: 'issue.opened', severity: 'info', team: 'team-data', actor: 'pieter', title: 'Issue geopend: documenteer FSC-koppeling', resource: 'repo-datadeling', target: '/code/repo-datadeling', at: 'di 14:12' },
