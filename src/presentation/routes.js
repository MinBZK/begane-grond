...
export const routes = [
  ...
  // (correct on prev/next/deep links). Texts are written as one flowing story.
  {
    ...
    chain: true,
    lead: 'Eén begrip uit AWIR artikel 3, de toeslagpartner, door vijf rollen: van wetstekst tot draaiende dienst.',
    slides: [
      {
        id: 'est-intro',
        title: 'Het stokje heet artikel 3',
        lead: 'Het partnerbegrip uit AWIR artikel 3 bepaalt mede het recht op toeslag. We volgen het door vijf paar handen, en we zijn ze allemaal.',
        bullets: [
          'We worden ze één voor één: de app kleurt mee met wie we zijn.',
          'Hetzelfde artikel, vijf keer een andere bril.',
          'De slide duidt, het scherm bewijst.',
        ],
        full: true,
      },
      {
        ...
        lead: 'We zijn nu Bram de Wit, beleidsmaker bij Toeslagen. Zijn AWIR, zijn vraag bij artikel 3: kan de uitvoering uit de voeten met het begrip toeslagpartner?',
        bullets: [
          'Artikel 3 als toets: bsn erin, heeft_toeslagpartner eruit, partner uit de BRP.',
          'Bram voert de wet live uit op een casus en ziet de uitkomst met de trace.',
          '64% van de AWIR-logica is al machine-leesbaar: uitvoerbaar, geen PDF.',
        ],
        route: '/wetten/awir',
      ...
      },
      {
        ...
        lead: 'Uitvoerbaar is de helft, bevoegd de andere. Welk wetsartikel autoriseert wie?',
        bullets: [
          'Elke schakel wijst terug naar een artikel: geen bevoegdheid zonder grondslag.',
          'Artikel 3 leest straks de BRP; hier zien we waarom dat mag.',
          'Brams etappe is af: uitvoerbaar, op een grondslag die staat.',
        ],
        route: '/governance/bevoegdheid',
        skippable: true,
      },
      {
        ...
        lead: 'Bram laat een uitvoerbaar artikel met een harde grondslag achter. Lieke Jansen, jurist, maakt er nu een machine-leesbare regel van.',
      ...
      },
      {
        ...
        lead: 'We zijn nu Lieke Jansen, jurist. Dezelfde wet, een andere bril: de machine-leesbare regel moet precies zeggen wat artikel 3 zegt.',
        bullets: [
          'De regel als code: bsn in, heeft_toeslagpartner uit, partner uit de BRP.',
          'Lieke stelt een wijziging voor (partner alleen op gezamenlijk adres) en de scenario’s draaien opnieuw: het LAT-geval mislukt.',
          'Huurtoeslag en zorgtoeslag nemen dit straks ongezien over: nu in één keer goed.',
        ],
        route: '/wetten/awir',
      ...
      },
      {
        ...
        lead: 'Partners uit de BRP lezen is persoonsgegevens verwerken. We lopen de verwerking eronder na.',
        bullets: [
          "'Vaststellen recht op toeslag' staat in het register, op grondslag van de AWIR zelf.",
          'Betrokkenen: aanvragers én toeslagpartners. DPIA gedaan, risico op hoog.',
          'Bewaartermijn zeven jaar, registers BRP en inkomen: ook het einde is geregeld.',
        ],
      ...
      },
      {
        ...
        lead: 'Machine-leesbaar, grondslag vast, DPIA gedaan. Sanne Visser, backend developer, brengt de regel nu door de pijplijn naar productie.',
      ...
      },
      {
        ...
        lead: 'We zijn nu Sanne Visser, backend developer. Liekes regel landt hier: minbzk/toeslagenmotor, de repo van het team.',
        bullets: [
          'Rust, open onder EUPL-1.2: iedereen kan nalezen hoe de overheid de toeslagpartner bepaalt.',
          'De overdracht is geen document maar een diff: Lieke en Sanne werkten al op dezelfde branch.',
        ],
        route: '/code/repo-toeslagen',
      },
      {
        ...
        lead: 'Code wordt pas een dienst als hij draait. De Toeslagenmotor als applicatie: repo, pijplijn en omgevingen bij elkaar.',
        bullets: [
          'Artikel 3 is hier gedrag, geen tekst: per aanvraag beantwoordt de dienst heeft_toeslagpartner.',
          'We zien wat in test staat en wat in productie draait: precies wat we zo promoten.',
        ],
      ...
      },
      {
        ...
        lead: 'Het moment zelf: we promoten de Toeslagenmotor van test naar productie, langs elke gate.',
        bullets: [
          'Elke gate toetst live: faalt er een, dan overrulen mag, met motivatie in het auditlog.',
          'Geen ticket, geen wachtrij: wij zetten de stap, het platform houdt het spoor bij.',
          'Vanaf nu beantwoordt Liekes regel echte aanvragen.',
        ],
        route: '/environments/promotie/app-toeslagen',
        drive: { wizard: 'promotie' },
      },
      {
        ...
        lead: 'En nu begint het werk van Samira Haddad, security officer: mag het algoritme erachter beslissen, en dwingen de gates dat af?',
      ...
      },
      {
        ...
        lead: 'We zijn nu Samira Haddad, security officer. Een algoritme beslist hier over een burger, zonder mens in de loop. Mag dat?',
        bullets: [
          'Het toetst hetzelfde begrip uit artikel 3, in de Toeslagenmotor van Sanne.',
          'Geen mens in de loop, dus de discriminatietoets is de waarborg. Samira draait hem live opnieuw.',
          'En het staat openbaar in het algoritmeregister.',
        ],
      ...
      },
      {
        ...
        lead: 'Eén keer goedkeuren is niet genoeg: de dienst verandert door. Samiras eisen staan als gates in de pijplijn, dezelfde die Sanne groen zag worden.',
        bullets: [
          'Beleid als code: scherp een eis aan, dan rolt die uit met review en historie.',
      ...
      },
      {
        ...
        lead: 'Getoetst en afgedwongen. Daan Koster, business analist, loopt de laatste etappe: hoe goed is de data waar de keten op rekent?',
      ...
      },
      {
        ...
        lead: 'We zijn nu Daan Koster, business analist. Een toets is zo goed als zijn input, en alles hangt op één gegeven: wie iemands partner is.',
        bullets: [
          'Persoonsgegevens (BRP): kwaliteit goud, volledigheid 99%, realtime. De actuele stand, geen kopie.',
          'Daan haalt live een verse verversing op: de nieuwe run komt bovenaan.',
          'Precies de data waarvoor Lieke de grondslag naliep, en die artikel 3 als input leest.',
        ],
      ...
      },
      {
        ...
        lead: 'Achter de dataset ligt het register: de BRP, beheerd door RvIG. Hier eindigt het stokje, waar artikel 3 zijn input leest.',
        bullets: [
          'Het partnergegeven hier is letterlijk de input van artikel 3: verder terug gaat de keten niet.',
          'Beschikbaarheid 99,95%: hapert de BRP, dan hapert de toets.',
      ...
      },
      {
        ...
        lead: 'Eén begrip, vijf schermen: artikel, regel, code, besluit, gegeven. Het stokje viel nergens, en elke overdracht liet een spoor na.',
        bullets: [
          'Dit kun je niet inkopen. Een keten van wetsartikel tot draaiende dienst bouw je.',
          'Vijf rollen, één platform, niemand wachtte: iedereen op dezelfde bron.',
          'Verandert artikel 3, dan loopt de estafette opnieuw, langs hetzelfde spoor.',
        ],
        full: true,
      },
    ],
  ...
  // subject is self-service: you request a name yourself, signed in via SSO Rijk,
  // and the platform makes it authorized, compliant and traceable by default.
  {
    id: 'domeinen-estafette',
    role: 'Een naam regel je zelf',
    persona: 'sanne',
    icon: 'globe',
    chain: true,
    ...
    slides: [
      ...
      },
      {
        ...
        route: '/dns/naamruimtes',
        full: true,
        gov: 'internet.nl en WCAG zijn pas-toe-of-leg-uit. Self-service maakt ze de standaard, niet de uitzondering.',
      },
      {
        id: 'dom-est-pieter-register',
        becomePersona: 'pieter',
        title: 'Iemand bewaakt de grenzen',
        lead: 'We zijn Pieter, registry-beheerder bij Logius. Hij beheert de root en bepaalt welke organisatie welke ruimte krijgt, zodat jij daarbinnen je gang kunt gaan.',
        bullets: [
          'Eén register, data-gedreven: naamruimtes, regels, standaarden.',
          'De grenzen staan vast; daarbinnen is het self-service.',
        ],
        route: '/dns/naamruimtes',
      },
      {
      ...
      },
      {
        ...
        lead: 'belastingdienst.gov.nl is toegewezen. Sanne Visser, developer bij Toeslagen, vraagt er zelf een dienst onder aan.',
      ...
      },
      {
        ...
        title: 'Waar het kan: meteen klaar',
        lead: 'Op alpha.gov.nl en beta.gov.nl is het puur self-service: geen goedkeuring, het domein staat er direct. Productie vraagt één akkoord, en dat ligt dichtbij.',
        bullets: [
          'Experimenteren en bouwen: zelf, meteen.',
          'Productie: één akkoord van je eigen organisatie, geen centrale wachtrij.',
        ],
        route: '/dns/aanvragen',
        skippable: true,
      },
      ...
      },
      {
        ...
        lead: 'examenregister.overheid.nl verhuist naar gov.nl. Geen losse knop, maar een aanvraag die geverifieerd en goedgekeurd wordt, en die net zo goed vastligt.',
        bullets: [
